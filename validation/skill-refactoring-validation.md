...
### 2.5 `skill/implement-single/SKILL.md` — Overlap Analysis
...
The remaining 4 skill files (implement, audit, ship, implement-single) do NOT have corresponding command files. Their overlap analysis is scoped to AGENTS.md only (covered in AC 2 above).
...
### 4.5 `skill/implement-single/SKILL.md` — Cross-References
