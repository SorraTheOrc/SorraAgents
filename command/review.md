...
1. Determine canonical work item id (agent responsibility)
...
1. Start review container (agent responsibility)
...
1. Check out the PR inside the container (agent responsibility)
...
1. Audit the code against acceptance criteria (agent responsibility)
...
1. Review the code (agent responsibility)
...
1. Discover and run the repository test suite (agent responsibility)
...
1. Post results (agent responsibility)
