...
This command emits a concise Markdown summary of docs/dev/Workflow.md focused on the four core workflow steps and the specific OpenCode commands used in each step. It is intended as a quick reference for contributors working with Worklog work items and PRDs.
...
- A shared issue tracker (this repo uses `wl` / Worklog work items).
...
- Commands in this step: `/intake <Project Title>`, `/prd <Work Item ID>`
...
- Create wl tasks for implementation, infra, docs, and tests; link to the PRD and epic.
...
- Commands in this step: `plan <Work Item ID>`, `doc <Work Item ID>`, `testplan <Work Item ID>`, `implement <Work Item ID>`
