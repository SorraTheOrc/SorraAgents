...
if (!SCRIPT_EXISTS) {
  test('installer warm-pool tests skipped when install-ampa script is unavailable', { skip: 'skill/install-ampa/scripts/install-worklog-plugin.sh is not present' }, () => {});
} else {
